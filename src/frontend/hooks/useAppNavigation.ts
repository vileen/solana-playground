...
export function useAppNavigation() {
   ...
   */
  const navigateToTab = (tabIndex: number, options: NavigationOptions = {}) => {
   ...
   */
  const navigateToNftHolders = (searchTerm?: string, options: NavigationOptions = {}) => {
   ...
   */
  const navigateToTokenHolders = (searchTerm?: string, options: NavigationOptions = {}) => {
   ...
   */
  const navigateToSocialProfiles = (searchTerm?: string, options: NavigationOptions = {}) => {
